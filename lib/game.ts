...
export type Game = { id: string; judgingMode: JudgingMode; roundSeconds: 10 | 30 | 90 | 180; hostId: string; phase: Phase; players: Player[]; rounds: Round[]; promptIndex: number; createdAt: string };
